...
fun com.viktormykhailiv.kmp.health.records.SleepSessionRecord.Stage.fromHealthKMPSleepStage(): SleepSessionRecord.Stage {
    return SleepSessionRecord.Stage(
        ...
        endTime = this.endTime,
        type = when (this.type) {
            com.viktormykhailiv.kmp.health.records.SleepStageType.Awake -> SleepStageType.Awake
            com.viktormykhailiv.kmp.health.records.SleepStageType.AwakeInBed -> SleepStageType.AwakeInBed
            com.viktormykhailiv.kmp.health.records.SleepStageType.Deep -> SleepStageType.Deep
            com.viktormykhailiv.kmp.health.records.SleepStageType.Light -> SleepStageType.Light
            com.viktormykhailiv.kmp.health.records.SleepStageType.OutOfBed -> SleepStageType.OutOfBed
            com.viktormykhailiv.kmp.health.records.SleepStageType.REM -> SleepStageType.REM
            com.viktormykhailiv.kmp.health.records.SleepStageType.Sleeping -> SleepStageType.Sleeping
            com.viktormykhailiv.kmp.health.records.SleepStageType.Unknown -> SleepStageType.Unknown
        }
    )
}

fun com.viktormykhailiv.kmp.health.units.Mass.fromHealthKMPMass(): Mass {
    return Mass.grams(this.inGrams)
}